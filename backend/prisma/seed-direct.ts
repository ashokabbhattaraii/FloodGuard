...
async function main() {
  ...
  const regions = [koshiBasin, saptariDistrict, kathmanduValley, chitwan, rautahat, rupandehi, banke, kailali, bardiya, sunsari];
  ...
  console.log('✅ 20 sensors created\n');

  // 4. Create Shelters
  console.log('🏠 Creating shelters...\n');

  const shelters = [
    { regionId: koshiBasin.id, shelterName: 'Biratnagar City Hall Shelter', address: 'Main Road, Biratnagar', latitude: 26.4546, longitude: 87.2721, capacity: 500, currentCount: 0, facilities: ['Medical Aid', 'Food', 'Water', 'Blankets', 'Toilets'], contactPhone: '+977-021-525252' },
    { regionId: saptariDistrict.id, shelterName: 'Rajbiraj District School', address: 'Education Road, Rajbiraj', latitude: 26.5430, longitude: 86.7468, capacity: 350, currentCount: 0, facilities: ['Food', 'Water', 'First Aid', 'Toilets'], contactPhone: '+977-031-520125' },
    { regionId: kathmanduValley.id, shelterName: 'Ratna Park Community Center', address: 'Ratna Park, Kathmandu', latitude: 27.7095, longitude: 85.3140, capacity: 800, currentCount: 12, facilities: ['Medical Aid', 'Food', 'Water', 'Blankets', 'Electricity', 'Toilets'], contactPhone: '+977-01-4223456' },
    { regionId: kathmanduValley.id, shelterName: 'Balkumari Sports Complex', address: 'Balkumari, Lalitpur', latitude: 27.6890, longitude: 85.3350, capacity: 600, currentCount: 0, facilities: ['Food', 'Water', 'Medical Aid', 'Blankets', 'Toilets'], contactPhone: '+977-01-5538822' },
    { regionId: chitwan.id, shelterName: 'Bharatpur Municipal Hall', address: 'Narayangadh, Bharatpur', latitude: 27.6780, longitude: 84.4324, capacity: 450, currentCount: 8, facilities: ['Medical Aid', 'Food', 'Water', 'Blankets', 'Toilets'], contactPhone: '+977-056-522145' },
    { regionId: rautahat.id, shelterName: 'Gaur Community School', address: 'Gaur Municipality', latitude: 26.9854, longitude: 85.2898, capacity: 300, currentCount: 0, facilities: ['Food', 'Water', 'First Aid', 'Toilets'], contactPhone: '+977-055-411236' },
    { regionId: rupandehi.id, shelterName: 'Butwal Engineering College', address: 'Kalikanagar, Butwal', latitude: 27.7000, longitude: 83.4655, capacity: 550, currentCount: 0, facilities: ['Medical Aid', 'Food', 'Water', 'Blankets', 'Toilets'], contactPhone: '+977-071-540232' },
    { regionId: banke.id, shelterName: 'Nepalgunj Medical College Hall', address: 'Kohalpur, Nepalgunj', latitude: 28.0515, longitude: 81.6200, capacity: 400, currentCount: 0, facilities: ['Medical Aid', 'Food', 'Water', 'Electricity', 'Toilets'], contactPhone: '+977-081-525645' },
    { regionId: kailali.id, shelterName: 'Dhangadhi Multi-Purpose Hall', address: 'Attaria Road, Dhangadhi', latitude: 28.6970, longitude: 80.5920, capacity: 350, currentCount: 0, facilities: ['Food', 'Water', 'First Aid', 'Blankets', 'Toilets'], contactPhone: '+977-091-522145' },
    { regionId: bardiya.id, shelterName: 'Gulariya District Center', address: 'Gulariya, Bardiya', latitude: 28.2145, longitude: 81.3562, capacity: 280, currentCount: 0, facilities: ['Food', 'Water', 'Medical Aid', 'Toilets'], contactPhone: '+977-084-400215' },
    { regionId: sunsari.id, shelterName: 'Inaruwa Youth Center', address: 'Inaruwa, Sunsari', latitude: 26.5122, longitude: 87.2356, capacity: 320, currentCount: 0, facilities: ['Food', 'Water', 'First Aid', 'Blankets', 'Toilets'], contactPhone: '+977-025-580445' },
    { regionId: koshiBasin.id, shelterName: 'Biratnagar Technical School', address: 'Airport Road, Biratnagar', latitude: 26.4890, longitude: 87.2650, capacity: 400, currentCount: 0, facilities: ['Food', 'Water', 'Medical Aid', 'Toilets'], contactPhone: '+977-021-535678' },
  ];
  ...
  console.log('✅ 12 shelters created\n');
